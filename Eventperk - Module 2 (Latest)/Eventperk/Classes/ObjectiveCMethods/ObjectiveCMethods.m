...
@implementation ObjectiveCMethods
...
+(NSString *) findUniqueSavePath
{
    ...
    path=[NSString stringWithFormat:@"%@.jpg",[df stringFromDate:[NSDate date]]];
...
#pragma mark - Null Replacement

+ (NSMutableArray *)arrayByReplacingNullsWithBlanks:(NSArray *)arrData
{
    NSMutableArray *replaced = [arrData mutableCopy];
