...
open class AAPopUp: UIViewController {
    ...
    var viewController: AboutEditViewController!
    
    var viewControllerdelegate: dismissPopDelegate!
    ...
    public convenience init(popup: AAPopUps<String?, String>, withOptions options: AAPopUpOptions? = nil) {
        ...
        self.viewController = getViewController(popup) as! AboutEditViewController
        initOptions(options)
    ...
    func setDelegate(controller:EditProfileViewController)
    {
        self.viewController.delegate = controller
    }
    
    func setText(text:String)
    {
        self.viewController.txt_About.text = text
    }
    ...
    public convenience init(popup: UIViewController,
        ...
        self.init()
        self.viewController = popup as! AboutEditViewController
...
extension AAPopUp {
    ...
    open func present(completion: ((_ popup: AAPopUp) -> ())?) {
        ...
        presentedViewController?.present(self, animated: false, completion: {
            completion?(self)
        })
